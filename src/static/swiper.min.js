...
!(function(e, t) {
  ...
  function c(e) {
    const t = 'function' == typeof Map ? new Map() : void 0
    return (c = function(e) {
      if (
        null === e ||
  ...
  function S() {
    for (
      ...
      if (null != a)
        for (
          let i = Object.keys(Object(a)), s = 0, r = i.length;
          s < r;
          s += 1
        ) {
          const n = i[s],
      ...
      update: {
            ...
            for (
              ...
              if ('none' !== I.css('display')) {
                if ('auto' === a.slidesPerView) {
                  const H = t.getComputedStyle(I[0], null),
                  ...
                  if (
                    ...
                    const V = parseFloat(H.getPropertyValue('width') || 0),
                    ...
                    const K = parseFloat(H.getPropertyValue('height') || 0),
        ...
        updateActiveIndex: function(e) {
          ...
          if (r.indexOf(i) >= 0) t = r.indexOf(i)
            ...
            const c = Math.min(n.slidesPerGroupSkip, p)
        ...
        addSlide: function(e, t) {
          ...
          if (e <= 0) a.prependSlide(t)
            ...
            if ('object' == typeof t && 'length' in t) {
              for (let u = 0; u < t.length; u += 1) t[u] && i.append(t[u])
              l = r > e ? r + t.length : r
            } else i.append(t)
            for (let c = 0; c < o.length; c += 1) i.append(o[c])
            s.loop && a.loopCreate(),
      ...
      handle: function(e) {
        ...
        if (
          ...
          if (!u) {
            ...
            let c = a.getTranslate() + r * i.sensitivity,
              h = a.isBeginning,
              v = a.isEnd
            if (
          ...
          T.length >= 2 && T.shift()
          const C = T.length ? T[T.length - 1] : void 0
          if (
            (T.push(b),
            C
      ...
      update: function() {
        ...
        if (
          ...
          if (
            ...
            if (a.dynamicBullets) {
              const y = Math.min(p.length, a.dynamicMainBullets + 4),
                w =
    ...
    te = {
      ...
      load: function() {
        ...
        if (n.loadPrevNext)
          if (l > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            ...
            const y = t.children('.' + a.slideNextClass)
      ...
      checkInViewOnLoad: function() {
        const e = l(),
          t = this
        if (t && !t.destroyed) {
          let a = t.params.lazy.scrollingElement
    ...
    oe = {
      setTranslate: function() {
        ...
        for (let v = 0; v < s.length; v += 1) {
          ...
          let b = Math.max(Math.min(f[0].progress, 1), -1),
            E = 0,
            x = 0,
            T = 0
          g % 4 == 0
